...
with open('src/tick.rs', 'w') as f:
    ...
    f.write('#[cfg(feature = "tick-u32")]\n')
    f.write('pub type TickType = u32;\n\n')
    f.write('#[cfg(not(feature = "tick-u32"))]\n')
    f.write('pub type TickType = u64;\n\n')
    for hz in ticks:
        f.write(
            f'#[cfg(feature = "tick-hz-{hz:_}")] pub const TICK_HZ: TickType = {hz:_};\n')
    f.write('#[cfg(not(any(\n')
    for hz in ticks:
        f.write(f'feature = "tick-hz-{hz:_}",\n')
    f.write(')))] pub const TICK_HZ: TickType = 1_000_000;')
